...
import { Container,Card,Typography,TextField,Button,Stack } from '@mui/material';
...
export default function SearchTitre() {
    ...
    function handleSubmit(e){
        ...
        if(titre==''){
           ...
           axios.get('http://localhost:8084/articles/api/get/'+titre,{
                headers: {
    ...
    return(<>
            ...
            <Typography sx={{ fontSize: 25 }} color="text.primary" align="center" gutterBottom>Recherche par titre
                </Typography>
                <Stack direction="row">
                
                <TextField sx={{ width:400 }}id="outlined-basic" label="Titre article :" variant="outlined" value={titre} onChange={(e)=>setTitre(e.target.value)}/>
